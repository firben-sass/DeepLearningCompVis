...
from lib.dataset.Datasets import BoundingBoxDataset
...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=["BoundingBoxDataset"],
        default="BoundingBoxDataset",
    ...
    parser.add_argument(
        ...
        choices=["rcnn"],
        default="rcnn",
        help="Object detection architecture to train.",
    )
    parser.add_argument(
        "--loss",
        type=lambda value: value.lower(),
...
def main():
    ...
    dataset_map = {
        "PH2": PH2,
        "DRIVE": DRIVE,
        "BoundingBoxDataset": BoundingBoxDataset
    }
